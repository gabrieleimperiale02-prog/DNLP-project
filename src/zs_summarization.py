...
# === Limited to CNN/DailyMail ('prompts.py' is untouched) ===
ZS_NAIVE_PROMPT_STR = {
    "mistral": {"cnn": ZS_NAIVE_PROMPT_STR_FOR_MISTRAL["cnn"]},
    "claude": {"cnn": ZS_NAIVE_PROMPT_STR_FOR_CLAUDE["cnn"]},
}

ZS_KEYWORD_PROMPT_STR = {
    "mistral": {"cnn": ZS_KEYWORD_PROMPT_STR_FOR_MISTRAL["cnn"]},
    "claude": {"cnn": ZS_KEYWORD_PROMPT_STR_FOR_CLAUDE["cnn"]},
}
